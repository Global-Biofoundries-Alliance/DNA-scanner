...
class TestController(unittest.TestCase):
    ...
    def test_results_endpoint(self) -> None:
        ...
        for i in range(self.iterations):
            handle = open(self.sequence_path, 'rb')
            self.client.post('/api/upload', content_type='multipart/form-data', data={'seqfile': handle, 'prefix': "Succhini" + str(i)})
            ...
            for result in searchResult["result"]:
                ...
                self.assertTrue(result["sequenceInformation"]["name"].startswith("Succhini" + str(i)))
                self.assertTrue(result["sequenceInformation"]["id"].startswith("Succhini" + str(i)))
