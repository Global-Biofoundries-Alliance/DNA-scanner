...
class TestGeneArtPinger(unittest.TestCase):
    ...
    def test_authenticate(self):
        ...
        with self.assertRaises(Entities.AuthenticationError):
            GeneArt.GeneArt("USERNAME", "TOKEN")
    ...
    def test_projectValidate(self):
        ...
        response = self.pinger_example.projectValidate(
            listOfSequences, product)
    ...
    def test_pingerFunctions(self):
        ...
        self.assertEqual(messages2[0].messageType,
                         Entities.MessageType.HOMOLOGY)
        ...
        self.assertEqual(messages3[0].messageType,
                         Entities.MessageType.HOMOLOGY)
        ...
        offer2order = [sequenceOffer1.offers[0].key,
                       sequenceOffer0.offers[0].key]
        ...
        with self.assertRaises(Entities.InvalidInputError):
            self.pinger_example.order(offer2order)
